...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      "Espeto Swift de Frango com bacon",
      "Espeto Swift de Coxa e sobrecoxa",
      "Espeto Swift de Panceta",
      "Espeto Swift de Coraçãozinho",
      "Espeto Swift de Kafta",
      "Peça de Coração da Alcatra",
      "Peça de Ancho",
    ],
    stripe: "bg-red-500",
    badgeBg: "bg-red-100",
